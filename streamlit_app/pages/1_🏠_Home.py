...
Professional UI with Real NBE Banner
"""
...
if banner_b64:
    st.markdown(
        ...
        <div class="hero-container">
            <!-- Banner Image -->
            <img src="data:image/png;base64,{banner_b64}" class="banner-img" alt="NBE Banner" style="width:100%; border-radius:20px; box-shadow:0 15px 50px rgba(0,0,0,0.4);">
            ...
            ">
                <div class='hero-title'>NBE Credit Risk Intelligence</div>
                <div class='hero-subtitle'>AI-Powered Credit Risk Analytics Platform</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True
