...
capabilities = [
    ...
    {"icon": "https://img.icons8.com/ios-filled/50/ffffff/combo-chart.png", "text": "Portfolio Intelligence"},
    {"icon": "https://img.icons8.com/ios-filled/50/ffffff/analytics.png", "text": "Model Governance"}
]
